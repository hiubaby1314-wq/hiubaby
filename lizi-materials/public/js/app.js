// === DEFAULT DATA (built into code, serves as baseline) ===
const DEF_CHARS=[
{id:1,name:'蝴蝶女孩',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#831843,#ec4899,#fbcfe8)',files:['png','fla'],img:'assets/蝴蝶女孩.png',fla:'assets/蝴蝶女孩.fla'},
{id:3,name:'灰衣',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#374151,#6b7280,#d1d5db)',files:['png','fla'],img:'assets/灰衣.png',fla:'assets/灰衣.fla'},
{id:34,name:'新潮妹妹',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#4c1d95,#7c3aed,#1f2937)',files:['png','fla'],img:'assets/新潮妹妹.png',imgs:['assets/新潮妹妹.png','assets/新潮妹妹动作.png'],fla:'assets/新潮妹妹.fla'},
{id:35,name:'校服少女',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#312e81,#4338ca,#e0e7ff)',files:['png','fla'],img:'assets/校服少女.png',fla:'assets/校服少女.fla'},
{id:36,name:'蓝衣警花',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#1e3a5f,#60a5fa,#1e293b)',files:['png','fla'],img:'assets/蓝衣警花.png',fla:'assets/蓝衣警花.fla'},
{id:37,name:'银发学院少年',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#312e81,#6366f1,#c7d2fe)',files:['png','fla'],img:'assets/银发学院少年.png',fla:'assets/银发学院少年.fla'},
{id:38,name:'紫发街头少年',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#1e1b4b,#7c3aed,#4b5563)',files:['png','fla'],img:'assets/紫发街头少年.png',fla:'assets/紫发街头少年.fla'},
{id:39,name:'校服少年',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#1e3a5f,#3b82f6,#6b7280)',files:['png','fla'],img:'assets/校服少年.png',fla:'assets/校服少年.fla'},
{id:40,name:'破衣幽魂',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#1c1917,#57534e,#a8a29e)',files:['png','fla'],img:'assets/破衣幽魂.png',fla:'assets/破衣幽魂.fla'},
{id:41,name:'卷发编辫少女',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#78716c,#d6d3d1,#292524)',files:['png','fla'],img:'assets/卷发编辫少女.png',fla:'assets/卷发编辫少女.fla'},
{id:42,name:'金发风衣少年',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#a16207,#fde68a,#1e293b)',files:['png','fla'],img:'assets/金发风衣少年.png',fla:'assets/金发风衣少年.fla'},
{id:44,name:'泳装少女',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#4b5563,#818cf8,#e0e7ff)',files:['png','fla'],img:'assets/泳装少女.png',fla:'assets/泳装少女.fla'},
{id:45,name:'新潮妹妹表情',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#1e1b4b,#6366f1,#c7d2fe)',files:['gif','fla'],img:'assets/新潮妹妹表情.gif',imgs:['assets/新潮妹妹表情.gif'],fla:'assets/新潮妹妹表情.fla'},
{id:46,name:'美男表情',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#9ca3af,#c4b5fd,#e5e7eb)',files:['gif','fla'],img:'assets/美男表情.gif',imgs:['assets/美男表情.gif'],fla:'assets/美男表情.fla'},
{id:47,name:'手枪',isNew:true,cat:'道具栏',grad:'linear-gradient(160deg,#1f2937,#d4af37,#f5f5f4)',files:['png','fla'],img:'assets/手枪.png',fla:'assets/手枪.fla'},
{id:48,name:'手机',isNew:true,cat:'道具栏',grad:'linear-gradient(160deg,#475569,#94a3b8,#cbd5e1)',files:['png','fla'],img:'assets/手机.png',fla:'assets/手机.fla'},
{id:49,name:'奶茶',isNew:true,cat:'道具栏',grad:'linear-gradient(160deg,#92400e,#d4a574,#fef3c7)',files:['png','fla'],img:'assets/奶茶.png',fla:'assets/奶茶.fla'},
{id:53,name:'吉他',isNew:true,cat:'道具栏',grad:'linear-gradient(160deg,#1e3a5f,#e2e8f0,#f8fafc)',files:['png','fla'],img:'assets/吉他.png',fla:'assets/吉他.fla'},
{id:50,name:'Q版魔鬼',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#1c1917,#991b1b,#292524)',files:['png','fla'],img:'assets/Q版魔鬼.png',fla:'assets/Q版魔鬼.fla'},
{id:51,name:'Q版天使',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#fefce8,#eab308,#f5f5f4)',files:['png','fla'],img:'assets/Q版天使.png',fla:'assets/Q版天使.fla'},
{id:52,name:'蓝裙美女',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#1e1b4b,#3b82f6,#f8fafc)',files:['png','fla'],img:'assets/蓝裙美女.png',fla:'assets/蓝裙美女.fla'},
{id:54,name:'宝箱',isNew:true,cat:'道具栏',grad:'linear-gradient(160deg,#1c1917,#92400e,#d97706)',files:['png','fla'],img:'assets/寶箱.png',fla:'assets/寶箱.fla'},
{id:55,name:'宝箱2',isNew:true,cat:'道具栏',grad:'linear-gradient(160deg,#1e3a5f,#2563eb,#38bdf8)',files:['png','fla'],img:'assets/寶箱2.png',fla:'assets/寶箱2.fla'},
{id:56,name:'宝箱3',isNew:true,cat:'道具栏',grad:'linear-gradient(160deg,#1e1b4b,#7c3aed,#a78bfa)',files:['png','fla'],img:'assets/寶箱3.png',fla:'assets/寶箱3.fla'},
{id:57,name:'发带',isNew:true,cat:'道具栏',grad:'linear-gradient(160deg,#831843,#ec4899,#fbcfe8)',files:['png','fla'],img:'assets/髮帶.png',fla:'assets/髮帶.fla'},
{id:58,name:'情侣运动装',isNew:true,cat:'人物',grad:'linear-gradient(160deg,#4c1d95,#7c3aed,#e0e7ff)',files:['png','fla'],img:'assets/情侶運動裝.png',fla:'assets/情侶運動裝.fla'},
{id:59,name:'运动女孩单面',isNew:true,limit:true,cat:'人物',grad:'linear-gradient(160deg,#ea580c,#fb923c,#fed7aa)',files:['png','fla'],img:'assets/運動女孩單面.png',fla:'assets/運動女孩單面.fla'},
{id:60,name:'斯文妹妹',isNew:true,limit:true,cat:'人物',grad:'linear-gradient(160deg,#0f766e,#14b8a6,#99f6e4)',files:['png','fla'],img:'assets/斯文妹妹.png',fla:'assets/斯文妹妹.fla'},
{id:62,name:'国民小哥',isNew:true,limit:true,cat:'人物',grad:'linear-gradient(160deg,#1e40af,#3b82f6,#93c5fd)',files:['png','fla'],img:'assets/國民小哥.png',fla:'assets/國民小哥.fla'},
{id:11,name:'紫发爱心正面',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#7c3aed,#c084fc,#f9a8d4)',files:['fla','png'],img:'assets/紫髮愛心正面.png',imgs:['assets/紫髮愛心正面.png'],fla:'assets/紫髮愛心正面.fla'},
{id:21,name:'紫发爱心侧面',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#8b5cf6,#c4b5fd,#ede9fe)',files:['fla','gif'],img:'assets/紫髮愛心側.gif',imgs:['assets/紫髮愛心側.gif'],fla:'assets/紫髮愛心側面.fla'},
{id:22,name:'紫发爱心正侧',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#6d28d9,#a78bfa,#ddd6fe)',files:['fla','gif'],img:'assets/紫髮愛心正側.gif',imgs:['assets/紫髮愛心正側.gif'],fla:'assets/紫髮爰心正側.fla'},
{id:12,name:'国民哥哥表情',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#0f766e,#14b8a6,#99f6e4)',files:['fla','gif'],img:'assets/國民哥哥表情.gif',imgs:['assets/國民哥哥表情.gif'],fla:'assets/國民哥哥表情.fla'},
{id:13,name:'彩虹表情',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#f43f5e,#fb923c,#facc15,#4ade80,#38bdf8,#a78bfa)',files:['fla','gif'],img:'assets/彩虹表情.gif',imgs:['assets/彩虹表情.gif'],fla:'assets/彩虹表情.fla'},
{id:14,name:'银发少年正面',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#94a3b8,#cbd5e1,#e2e8f0)',files:['fla','png'],img:'assets/銀髮少年正面.png',imgs:['assets/銀髮少年正面.png'],fla:'assets/銀髮少年正面.fla'},
{id:23,name:'银发少年正侧',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#64748b,#94a3b8,#cbd5e1)',files:['fla','png'],img:'assets/銀髮少年正側.png',imgs:['assets/銀髮少年正側.png'],fla:'assets/銀髮少年正側.fla'},
{id:15,name:'眼镜学长',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#78350f,#a16207,#fbbf24)',files:['fla','gif'],img:'assets/眼鏡學長.gif',imgs:['assets/眼鏡學長.gif'],fla:'assets/眼鏡學長.fla'},
{id:16,name:'猫耳少女正面',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#6b21a8,#a78bfa,#e9d5ff)',files:['fla','png'],img:'assets/猫耳少女正面.png',imgs:['assets/猫耳少女正面.png'],fla:'assets/貓耳少女正面.fla'},
{id:19,name:'猫耳少女正侧',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#7c3aed,#c084fc,#ede9fe)',files:['fla','png'],img:'assets/猫耳少女正侧.png',imgs:['assets/猫耳少女正侧.png'],fla:'assets/貓耳少女正側.fla'},
{id:20,name:'猫耳少女侧面',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#581c87,#9333ea,#d8b4fe)',files:['fla','png'],img:'assets/猫耳少女侧面.png',imgs:['assets/猫耳少女侧面.png'],fla:'assets/貓耳少女側面.fla'},
{id:17,name:'趣味男孩正面',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#ea580c,#fb923c,#fed7aa)',files:['fla','gif'],img:'assets/趣味男孩正面.gif',imgs:['assets/趣味男孩正面.gif'],fla:'assets/趣味男孩.fla'},
{id:24,name:'趣味男孩正侧',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#c2410c,#f97316,#fdba74)',files:['gif'],img:'assets/趣味男孩正侧.gif',imgs:['assets/趣味男孩正侧.gif']},
{id:18,name:'帅气少年正面',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#9ca3af,#d1d5db,#f3f4f6)',files:['fla','png'],img:'assets/帅气少年正面.png',imgs:['assets/帅气少年正面.png'],fla:'assets/帅气少年正面.fla'},
{id:25,name:'帅气少年正侧',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#6b7280,#9ca3af,#d1d5db)',files:['fla','png'],img:'assets/帅气少年正侧.png',imgs:['assets/帅气少年正侧.png'],fla:'assets/帅气少年正侧.fla'},
{id:26,name:'蓝发兽娘',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#1e3a5f,#2563eb,#f97316)',files:['fla','gif'],img:'assets/蓝发兽娘.gif',imgs:['assets/蓝发兽娘.gif'],fla:'assets/蓝发兽娘.fla'},
{id:27,name:'灰眼银发少年',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#6b7280,#9ca3af,#e5e7eb)',files:['fla','gif'],img:'assets/灰眼银发少年.gif',imgs:['assets/灰眼银发少年.gif'],fla:'assets/灰眼银发少年.fla'},
{id:28,name:'紫眼银发少年',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#7c3aed,#a78bfa,#e5e7eb)',files:['fla','gif'],img:'assets/紫眼银发少年.gif',imgs:['assets/紫眼银发少年.gif'],fla:'assets/紫眼银发少年.fla'},
{id:31,name:'黄眼表情',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#92400e,#d97706,#fbbf24)',files:['fla','gif'],img:'assets/黄眼表情.gif',imgs:['assets/黄眼表情.gif'],fla:'assets/黄眼表情.fla'},
{id:32,name:'祖红表情',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#881337,#e11d48,#fda4af)',files:['fla','png'],img:'assets/祖红表情.png',imgs:['assets/祖红表情.png'],fla:'assets/祖红表情.fla'},
{id:33,name:'可爱女表情',isNew:true,cat:'表情包',grad:'linear-gradient(160deg,#7c3aed,#c084fc,#fbcfe8)',files:['fla','png'],img:'assets/可爱女表情.png',imgs:['assets/可爱女表情.png'],fla:'assets/可爱女表情.fla'}
];
...
async function renderUsers(){
  ...
  try{
    ...
    document.getElementById('adminUserList').innerHTML='<strong>'+(isTw()?'已有帳號：':'已有账号：')+'</strong>'+d.users.map(u=>
      `<span>${u.username} <em style="font-size:11px;color:${u.role==='vip'?'#d97706':u.role==='promo'?'#ef4444':u.role==='admin'?'var(--primary)':'var(--text-light)'}">[${roleLabel(u.role)}]</em>${u.role!=='admin'?` <a href="#" onclick="toggleRole('${u.username}');return false" style="color:#d97706;margin-left:2px;font-size:11px">${isTw()?'切換':'切换'}</a><a href="#" onclick="delUser('${u.username}');return false" style="color:var(--red);margin-left:4px;font-size:11px">&times;</a>`:''}</span>`).join('');
  }catch(e){}
}
...
function openPreview(id){
  ...
  if(allImgs.length===0&&c.grad){
    ...
    document.getElementById('previewMainImg').parentElement.innerHTML='<div style="width:300px;height:400px;border-radius:8px;background:'+c.grad+';display:flex;align-items:center;justify-content:center;font-size:64px;color:rgba(255,255,255,.2)">'+c.name.charAt(0)+'</div>';
  ...
  if(allImgs.length>1){thumbsEl.innerHTML=allImgs.map((im,i)=>`<div class="preview-thumb${i===0?' active':''}" onclick="switchPreview('${im}',this)"><img src="${im}"></div>`).join('');}
  ...
  if(currentUser){
    ...
    const canDl=(role==='admin'||role==='vip'||(role==='user'&&c.cat==='表情包')||(role==='promo'&&(c.cat==='限時優惠'||c.cat==='限时优惠'||c.cat==='道具栏')));
    if(canDl){
      let btns='';
      if(c.fla){btns+=`<a class="preview-dl-btn fla-dl" href="${c.fla}" download="${c.name}.fla">下载FLA源文件</a>`;}
      dlArea.innerHTML=btns||'<div class="preview-login-hint">该素材暂无FLA文件</div>';
    }else{
      const upgradeMsg=role==='user'?'您的账号仅可下载表情包素材，升级VIP可下载全部素材':'您的账号仅可下载限时优惠素材，升级VIP可下载全部素材';
      dlArea.innerHTML=`<div class="preview-login-hint"> ${upgradeMsg}</div>`;
    }
  }else{
    dlArea.innerHTML='<div class="preview-login-hint"> 登录后即可下载素材 <button onclick="closePreview();openModal(\'loginModal\')" style="margin-left:8px;padding:4px 14px;border-radius:12px;background:var(--primary);color:#fff;font-size:12px;border:none;cursor:pointer">立即登录</button></div>';
  }
...
function renderCards(){
  ...
  grid.innerHTML=pageItems.map((c,i)=>`<div class="card" style="animation-delay:${i*.02}s" onclick="openPreview(${c.id})">
    <div class="card-img">
      <div class="card-badge"><span class="badge badge-copy">版权</span>${c.isNew?'<span class="badge badge-new">new</span>':''}${c.limit?'<span class="badge badge-limit">限时</span>':''}</div>
      <div class="card-admin-actions"><button class="card-admin-btn edit-btn" onclick="event.stopPropagation();openEditItem(${c.id})">&#9998;</button><button class="card-admin-btn del-btn" onclick="event.stopPropagation();delItem(${c.id})">&#10005;</button></div>
      ${c.img?`<div class="card-img-inner" style="background:#f5f5f5"><img src="${c.img}" style="width:100%;height:100%;object-fit:contain" onerror="this.parentElement.style.background='${c.grad}';this.remove()"></div>`
            :`<div class="card-img-inner" style="background:${c.grad}">${c.name.charAt(0)}</div>`}
    ...
    <div class="card-footer"><span class="card-name">${isTw()?matName(c.name):c.name}</span>
      <span class="card-preview" onclick="event.stopPropagation();openPreview(${c.id})">预览 &#9654;</span>
    </div></div>`).join('');
...
function addOneImg(){
  ...
  if(!file){document.getElementById('editImgCt').innerHTML='<span style="color:var(--red)">请先选择图片</span>';return;}
  if(upImgs.length>=5){document.getElementById('editImgCt').innerHTML='<span style="color:var(--red)">已达上限5张</span>';input.value='';return;}
...
function renderImgPrev(){
  document.getElementById('editImgPrev').innerHTML=upImgs.map((m,i)=>
    `<div style="position:relative;display:inline-block"><img src="${m.url}"><span onclick="rmImg(${i})" style="position:absolute;top:-4px;right:-4px;width:18px;height:18px;background:var(--red);color:#fff;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:11px;cursor:pointer">&times;</span></div>`).join('');
...
document.getElementById('editFla').addEventListener('change',function(){
  ...
  if(!f.name.toLowerCase().endsWith('.fla')){st.innerHTML='<span style="color:var(--red)">请选择.fla文件</span>';upFla=null;this.value='';return;}
...
function previewReqImgs(input){
  ...
  if(files.length>5){p.innerHTML='<span style="color:var(--red)">最多5张</span>';input.value='';return;}
  p.innerHTML='';
  for(let i=0;i<files.length;i++){const f=files[i];reqFiles.push(f);const r=new FileReader();r.onload=e=>{p.innerHTML+=`<img src="${e.target.result}">`};r.readAsDataURL(f);}
}
...
async function loadRequests(){
  ...
  try{
    ...
    if(!d.requests.length){list.innerHTML='<p style="color:var(--text-light)">暂无需求</p>';return;}
    list.innerHTML=d.requests.map(req=>{
      const time=new Date(req.createdAt).toLocaleString('zh-CN');
      const imgs=req.images&&req.images.length?req.images.map(im=>`<img src="${im}" style="max-height:80px;border-radius:4px;margin:4px 4px 0 0;cursor:pointer" onclick="window.open('${im}','_blank')">`).join(''):'';
      const statusColor=req.read?'#10b981':'#f59e0b';
      const statusText=req.read?(isTw()?'已讀':'已读'):(isTw()?'未讀':'未读');
      return `<div style="background:#f9fafb;border-radius:8px;padding:14px;margin-bottom:10px;border-left:4px solid ${statusColor}">
        <div style="display:flex;justify-content:space-between;margin-bottom:6px"><strong>${isTw()?s2t(req.desc):req.desc}</strong><span style="color:var(--text-light);font-size:12px">${time}</span></div>
        <div style="font-size:12px;color:var(--text-light);margin-bottom:6px">${isTw()?'聯繫方式':'联系方式'}：${req.contact} &nbsp;|&nbsp; <span style="color:${statusColor}">${statusText}</span></div>
        ${imgs}
        ${!req.read?`<button onclick="markRead(${req.id})" style="margin-top:6px;padding:3px 10px;border-radius:4px;background:var(--primary);color:#fff;font-size:11px;cursor:pointer;border:none">${isTw()?'標記已讀':'标记已读'}</button>`:''}
      </div>`;
    }).join('');
